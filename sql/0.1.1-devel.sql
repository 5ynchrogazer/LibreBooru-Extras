...
--
-- Host: localhost:3306
-- Generation Time: Dec 02, 2024 at 05:45 PM
...
CREATE TABLE `moderation_log` (
  ...
  `action` enum('delete_post','ban_user','approve_post','edit_tag','approve_post_report','reject_post_report') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
(1, 'Guest', 'view'),
(2, 'User', 'view, post, vote, comment, tag, wiki, report'),
(3, 'Mod', 'view, post, vote, comment, tag, wiki, moderate, report'),
(4, 'Admin', 'view, post, vote, comment, tag, wiki, moderate, admin, report');
