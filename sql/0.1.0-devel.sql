...
--
-- Host: localhost:3306
-- Generation Time: Nov 29, 2024 at 02:27 AM
...
CREATE TABLE `moderation_log` (
  ...
  `action` enum('delete_post','ban_user','approve_post','edit_tag') NOT NULL,
...
(1, 'Guest', 'view'),
(2, 'User', 'view, post, vote, comment, tag, wiki'),
(3, 'Mod', 'view, post, vote, comment, tag, wiki, moderate'),
(4, 'Admin', 'view, post, vote, comment, tag, wiki, moderate, admin');
