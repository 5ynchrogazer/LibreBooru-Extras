...
CREATE TABLE reports_posts (
    ...
    CONSTRAINT fk_reports_posts_post_id FOREIGN KEY (post_id) REFERENCES posts(post_id) ON DELETE CASCADE,
    CONSTRAINT fk_reports_posts_user_id FOREIGN KEY (user_id) REFERENCES users(user_id) ON DELETE CASCADE
);